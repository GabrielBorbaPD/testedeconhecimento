...
/* C:\xampp\htdocs\gestar\vendor\cakephp\bake\src\Template\Bake\Element\form.twig */
class __TwigTemplate_f77546875265134d5302122a55fcc03e1cac1a2d35979d0b88180fa8d1230860 extends Twig_Template
{
    ...
    {
        $__internal_ae074bb520c5ae90b9f0bf22640f6748aceea617d92018766a92bf00426ffc7c = $this->env->getExtension("WyriHaximus\\TwigView\\Lib\\Twig\\Extension\\Profiler");
        $__internal_ae074bb520c5ae90b9f0bf22640f6748aceea617d92018766a92bf00426ffc7c->enter($__internal_ae074bb520c5ae90b9f0bf22640f6748aceea617d92018766a92bf00426ffc7c_prof = new Twig_Profiler_Profile($this->getTemplateName(), "template", "C:\\xampp\\htdocs\\gestar\\vendor\\cakephp\\bake\\src\\Template\\Bake\\Element\\form.twig"));
...
";
        ...
        if ((strpos(($context["action"] ?? null), "add") === false)) {
            ...
            echo "],
                ['confirm' => __('Você tem certeza que deseja deletar a tarefa: {0}?', \$";
            // line 24
            echo twig_escape_filter($this->env, ($context["singularVar"] ?? null), "html", null, true);
            echo "->";
            echo twig_escape_filter($this->env, $this->getAttribute(($context["primaryKey"] ?? null), 0, array(), "array"), "html", null, true);
...
";
        ...
        $__internal_ae074bb520c5ae90b9f0bf22640f6748aceea617d92018766a92bf00426ffc7c->leave($__internal_ae074bb520c5ae90b9f0bf22640f6748aceea617d92018766a92bf00426ffc7c_prof);

    }

    public function getTemplateName()
    {
        return "C:\\xampp\\htdocs\\gestar\\vendor\\cakephp\\bake\\src\\Template\\Bake\\Element\\form.twig";
    }
...
{% if strpos(action, 'add') is same as(false) %}
        <li><?= \$this->Form->postLink(
                ...
                ['confirm' => __('Você tem certeza que deseja deletar a tarefa: {0}?', \${{ singularVar }}->{{ primaryKey[0] }})]
            )
        ?></li>
{% endif %}
