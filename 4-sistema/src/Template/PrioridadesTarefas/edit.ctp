...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $prioridadesTarefa->id],
                ['confirm' => __('Você tem certeza que deseja deletar a Prioridade: {0}?', $prioridadesTarefa->id)]
            )
        ?></li>
...
<div class="prioridadesTarefas form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Editar Prioridades') ?></legend>
        <?php
